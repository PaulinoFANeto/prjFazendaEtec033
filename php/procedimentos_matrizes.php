...
<body>
    ...
    <a href="add_procedimento_matriz.php">Adicionar Procedimento para Matriz</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Matriz</th>
        ...
        <tr>
            ...
            <td>
                <a href="edit_procedimento_matriz.php?id=<?php echo $row['id']; ?>">Editar</a>
                <a href="delete_procedimento_matriz.php?id=<?php echo $row['id']; ?>">Excluir</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
