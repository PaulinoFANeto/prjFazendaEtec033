...
<body>
    ...
    <a href="../admin/add/add_vacina_matriz.php">Adicionar Vacina para Matriz</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Matriz</th>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="../admin/edit/edit_vacina_matriz.php?id=<?php echo $row['id']; ?>">Editar</a>
                <a href="../admin/delete/delete_vacina_matriz.php?id=<?php echo $row['id']; ?>">Excluir</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
