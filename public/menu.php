    ...
    <nav>
        <div class="container-nav">
            <div class="grupo">
                <h3>Manejos</h3>
                <ul>
                    <li><a href="manejos/matrizes.php?from=menu.php">Matrizes</a></li>
                    <li><a href="manejos/crias.php?from=menu.php">Crias</a></li>
                    <li><a href="manejos/vacinas.php?from=menu.php">Vacinas</a></li>
                    <li><a href="manejos/procedimentos.php?from=menu.php">Procedimentos</a></li>
                    <li><a href="manejos/alimentos.php?from=menu.php">Nutrições</a></li>
                </ul>
            </div>
            ...
            <div class="grupo">
                <h3>Vacinação</h3>
                <ul>
                    <li><a href="vacinacao/vacinas_matrizes.php?from=menu.php">De Matrizes</a></li>
                    <li><a href="vacinacao/vacinas_crias.php?from=menu.php">De Crias</a></li>
                </ul>
            </div>
            ...
            <div class="grupo">
                ...
                <ul>
                    <li><a href="manejos_especiais/partos.php?from=menu.php">Partos</a></li>
                    <li><a href="manejos_especiais/coberturas.php?from=menu.php">Coberturas</a></li>
                </ul>
            </div>
            ...
            <div class="grupo">
                <h3>Procedimentos</h3>
                <ul>
                    <li><a href="procedimentos/procedimentos_matrizes.php?from=menu.php">Em Matrizes</a></li>
                    <li><a href="procedimentos/procedimentos_crias.php?from=menu.php">Em Crias</a></li>
                </ul>
            </div>
            ...
            <div class="grupo">
                <h3>Nutrição</h3>
                <ul>
                    <li><a href="nutricao/alimentacao_matrizes.php?from=menu.php">De Matrizes</a></li>
                    <li><a href="nutricao/alimentacao_crias.php?from=menu.php">De Crias</a></li>
                </ul>
            </div>
            ...
            <div class="grupo">
                <h3>Pesagem</h3>
                <ul>
                    <li><a href="pesagem/pesagem_matrizes.php?from=menu.php">De Matrizes</a></li>
                    <li><a href="pesagem/pesagem_crias.php?from=menu.php">De Crias</a></li>
                </ul>
            </div>
            ...
            if (isset($_SESSION['nivel_acesso']) && $_SESSION['nivel_acesso'] === 'Administrador') {
                echo '
                        <div class="grupo">
                            <h3>Configurações</h3>
                            <ul>
                                <ul><li><a href="../admin/config/configuracoes.php?from=menu.php">Configurações do Sistema</a></li></ul>
                            </ul>
                        </div>
                    ';
            }
