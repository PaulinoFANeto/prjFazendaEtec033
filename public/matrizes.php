    ...
    <div class="container">
        ...
        <div class="top-bar">
            ...
            <?php if (in_array('inclusao', $usuario_permissoes)): ?>
                <button class="btn" onclick="window.location.href='../admin/add/add_matriz.php'">Adicionar nova Matriz</button>
            <?php endif; ?>
        </div>
            ...
            <tr>
                ...
                <td>
                    <?php if (in_array('alteracao', $usuario_permissoes)): ?>
                        <button class="btn" onclick="window.location.href='../admin/edit/edit_matriz.php?id=<?php echo $row['id']; ?>'">Editar</button>
                    <?php endif; ?>
                    <?php if (in_array('exclusao', $usuario_permissoes)): ?>
                        ...
                        <button class="btn" onclick="if(confirm('Deseja realmente excluir a matriz <?php echo $row['nome'];?> ?' )) window.location.href='../admin/delete/delete_matriz.php?id=<?php echo $row['id']; ?>'">Excluir</button>
                    <?php endif; ?>
                </td>
            </tr>
            <?php endwhile; ?>
