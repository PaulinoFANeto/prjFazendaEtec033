<!--Arquivo criado apenas para testar se o envio de data da cobertura ocorre corretamente, 
irei ajustar estes arquivos antes de finalizar - Lays Gonçalves-->

<?php
include(__DIR__ . "/../../../auth/auth.php"); // ajuste o caminho se necessário
