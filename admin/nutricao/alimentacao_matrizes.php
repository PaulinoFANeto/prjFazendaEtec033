...
<body>
    ...
    <a href="../../admin/add/add_alimentacao_matriz.php">Adicionar Alimentação para Matriz</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Matriz</th>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="../../admin/edit/edit_alimentacao_matriz.php?id=<?php echo $row['id']; ?>">Editar</a>
                    <a href="../../admin/delete/delete_alimentacao_matriz.php?id=<?php echo $row['id']; ?>">Excluir</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
