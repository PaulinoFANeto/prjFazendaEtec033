...
<body>
    ...
    <a href="../../admin/add/add_alimentacao_cria.php">Adicionar Alimentação para Cria</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Cria</th>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="../../admin/edit//edit_alimentacao_cria.php?id=<?php echo $row['id']; ?>">Editar</a>
                    <a href="../../admin/delete/delete_alimentacao_cria.php?id=<?php echo $row['id']; ?>">Excluir</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
