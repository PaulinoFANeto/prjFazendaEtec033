...
<body>
    ...
    <a href="../../admin/add/add_vacina_cria.php">Adicionar Vacina para Cria</a>
    <table>
        <tr>
            <th>ID</th>
            <th>Cria</th>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="../../admin/add/edit_vacina_cria.php?id=<?php echo $row['id']; ?>">Editar</a>

                    <!-- O arquivo delete_vacina_cria.php não foi criado - Letícia -->
                    <a href="../../admin/delete/delete_vacina_cria.php?id=<?php echo $row['id']; ?>">Excluir</a>
                </td>
            </tr>
        <?php endwhile; ?>
    </table>
